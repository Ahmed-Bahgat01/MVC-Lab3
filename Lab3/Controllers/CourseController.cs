...
namespace StudentDeptMemoCRUD.Controllers
{
    public class CourseController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,LectureHours,LabHours")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,LectureHours,LabHours")] Course course)
        {
            if (id != course.Id)
            {
                return NotFound();
